...
constexpr VkColorComponentFlags kAllChannels =
    VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT |
    VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT;

[[nodiscard]] auto make_blend(
    VkBlendFactor src_color, VkBlendFactor dst_color, VkBlendOp color_op,
    VkBlendFactor src_alpha, VkBlendFactor dst_alpha, VkBlendOp alpha_op) noexcept
...
auto blend_state_for(noted::domain::BlendMode mode, bool& supported_out) noexcept
    -> VkPipelineColorBlendAttachmentState {
    ...
    switch (mode) {
        ...
        case BM::screen:
            ...
            return make_blend(
                VK_BLEND_FACTOR_ONE, VK_BLEND_FACTOR_ONE_MINUS_SRC_COLOR,
                VK_BLEND_OP_ADD,
                VK_BLEND_FACTOR_ONE, VK_BLEND_FACTOR_ONE_MINUS_SRC_ALPHA,
                VK_BLEND_OP_ADD);
...
auto LayerCompositor::slot_for(noted::domain::BlendMode mode,
    ...
    supported_out = true;
    switch (mode) {
        case BM::normal:       return Slot::normal;
        case BM::screen:       return Slot::screen;
        case BM::linear_dodge: return Slot::linear_dodge;
        case BM::multiply:     return Slot::multiply;
        default:
            supported_out = false;
            return Slot::normal;
    }
...
auto LayerCompositor::create(const CreateInfo& info) -> Result<LayerCompositor> {
    if (info.device == nullptr || info.vs_module == nullptr ||
    ...
    constexpr std::array<BM, static_cast<std::size_t>(Slot::count)> kModes{
        BM::normal, BM::screen, BM::linear_dodge, BM::multiply,
    };
...
void LayerCompositor::composite(
    VkCommandBuffer                   cb,
